...
import xss.it.jux.reactive.collections.internal.NonIterableChange.GenericAddRemoveChange;
...
/**
 * Wraps an {@link ObservableList} and filters its content using the provided
 * {@link Predicate}.
 *
 * <p>All changes in the source {@code ObservableList} are propagated
 * immediately to this {@code FilteredList}. When the predicate changes, the
 * entire list is re-filtered and listeners are notified.</p>
 *
...
public final class FilteredList<E> extends TransformationList<E, E> {
     ...
     * The provided predicate will match the elements in the source list that
     * will be visible. If the predicate is null, all elements will be matched
     * and the list is equal to the source list.
     *
     * @param source    the source list
     * @param predicate the predicate to match the elements or null to match
     *                  all elements
     */
     ...
     * of the source list.
     *
     * <p>This constructor might be useful if you want to bind
     * {@link #predicateProperty()} of this list.</p>
     *
     * @param source the source list
     */
    ...
    /**
     * The predicate that will match the elements that will be in this
     * FilteredList. Elements not matching the predicate will be filtered-out.
     * Null predicate means "always true" predicate, all elements will be
     * matched.
     */
    private ObjectProperty<Predicate<? super E>> predicate;

    /**
     * Returns the predicate property. Changing the property value triggers
     * a re-filter.
     *
    ...
    /**
     * Returns the current predicate, or {@code null} if all elements are
     * matched.
     *
     * @return the current predicate, or {@code null}
     */
    ...
    /**
     * Sets the predicate used to filter elements. Setting {@code null} means
     * all elements pass.
     *
    ...
    /**
     * Returns the number of elements in this filtered list.
     *
