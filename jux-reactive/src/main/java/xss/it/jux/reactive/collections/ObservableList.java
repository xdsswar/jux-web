...
/**
 * A list that allows listeners to track changes when they occur. Implementations can be created using methods
 * in {@link JuxCollections} such as {@link JuxCollections#observableArrayList() observableArrayList}.
 *
        ...
        Comparator<E> naturalOrder = new Comparator<>() {
            ...
            public int compare(E o1, E o2) {
                ...
                if (o1 instanceof Comparable) {
                    ...
                    Comparable<E> casted = (Comparable<E>) o1;
