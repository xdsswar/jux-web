...
import xss.it.jux.reactive.value.WritableLongValue;

/**
 * Full implementation of a {@link Property} wrapping a {@code long} value.
 * Setting or binding this property to a null value will set it to {@code 0L}.
 */
