...
import xss.it.jux.reactive.collections.SetChangeListener;

import java.util.Arrays;

/**
 * Helper class for managing invalidation and change listeners attached to an observable set.
 *
 ...
 *
 * @param <E> the element type of the observable set
 */
public abstract class SetListenerHelper<E> {
    ...
    /**
     * Adds a set change listener. If the helper is {@code null}, a new single-change
     * helper is created; otherwise the existing helper is promoted as needed.
     *
     * @param helper   the current helper instance, may be {@code null}
     * @param listener the set change listener to add, must not be {@code null}
     * @param <E>      element type
     * @return the (possibly new) helper instance
     * @throws NullPointerException if {@code listener} is {@code null}
     */
    ...
    /**
     * Removes a set change listener. Returns {@code null} when the last listener is removed.
     *
     * @param helper   the current helper instance, may be {@code null}
     * @param listener the set change listener to remove, must not be {@code null}
     * @param <E>      element type
     * @return the (possibly new) helper instance, or {@code null} if empty
     * @throws NullPointerException if {@code listener} is {@code null}
     */
